...
func (r *rbroker) PublishFanout(msg *broker.Message, opts ...broker.PublishOption) error {
	return r.Publish("", msg, opts...)
}
...
func (r *rbroker) SubscribeFanout(handler broker.Handler, opts ...broker.SubscribeOption) (broker.Subscriber, error) {
	return r.Subscribe("", handler, opts...)
}
